...
;
; :PURPOSE:
;     The purpose of this routine is to add a colour bar to the current graphics
...
;
;  :KEYWORDS:
;    BOTTOM   (IN:Value) The lowest colour index of the colours to be loaded
;                 in the bar.
;    CHARSIZE (IN:VALUE) The character size of the colour bar annotations.
;                 Default is 1.0.
;    COLOR    (IN:VALUE) The colour index of the bar outline and characters.
;                 Default is !P.Color.
...
;    NCOLORS  (IN:VALUE) This is the number of colours in the colour bar.
;    TITLE   (IN:STRING) This is title for the colour bar. The default is
;                 to have no title.
;    VERTICAL:  Setting this keyword give a vertical colour bar. The default
;                 is a horizontal colour bar.
;    TOP:       This puts the labels on top of the bar rather than under it.
;                 The keyword only applies if a horizontal colour bar
;                 is rendered.
;    RIGHT:     This puts the labels on the right-hand side of a vertical
;                 colour bar. It applies only to vertical colour bars.
...
;    INVERTCOLORS: Setting this keyword inverts the colours in the colour bar.
;    TICKNAMES (IN:STRARR) A string array of names or values for the tick marks.
;    REVERSE:   Setting this keyword reverses the colours in the colorbar.
...
;    WIDTH    (IN:VALUE) Width of the coloubar in normalised coordinate
...
;                 This is useful to shrink the horizontal colorbar length
;    YMARGIN  (IN:Value) Margin offset from bottom and top (def: [0,0].
;                 This is useful to shrink the vertical colorbar length
...
pro cbar,                       $
  ...
  ; Set input parameters for colorbar position
  ...
  ; - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  ; Estimate colorbar position in the Plot window
  ; - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  cbpos = vert  $
  ...
  ; - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  ; Sanity check for colorbar position
  ; - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
