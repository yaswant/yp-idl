...
;             /ADD_GAUSSIAN - Adds normal distribution line scaled to histogram frequency
...
;             _Extra - Inherits plot and colorbar properties
;
