...
FUNCTION Sps_Constants
    ...
    const = { Sps_Constants, $
        ...
        ; coefficient file. Channels 1-3 and 12 have been ignored because BTs
        ; are not meaningful for visible channels.
        ;----------------------------------------------------------------------
        planck_bc_coeff_a : [$
        ...
        ; brightness temperature increments to be added to background
        ; calculations.
        ;----------------------------------------------------------------------
